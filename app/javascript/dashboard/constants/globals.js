export default {
  ...
  DOCS_URL: 'https://neuchat.neutron.sg/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://neuchat.neutron.sg/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.neuchat.neutron.sg/content.json',
