...
describe('#mutations', () => {
      ...
      expect(state.records).toEqual([
        {
          id: 1,
          name: 'Agent1',
          email: 'agent1@neuchat.neutron.sg',
        },
      ]);
    });
  });
  ...
  describe('#ADD_AGENT', () => {
    it('push newly created agent data to the store', () => {
      ...
      mutations[types.default.ADD_AGENT](state, {
        id: 2,
        name: 'Agent2',
        email: 'agent2@neuchat.neutron.sg',
      });
      expect(state.records).toEqual([
        { id: 1, name: 'Agent1', email: 'agent1@neuchat.neutron.sg' },
        { id: 2, name: 'Agent2', email: 'agent2@neuchat.neutron.sg' },
      ]);
    });
  });
  ...
  describe('#EDIT_AGENT', () => {
    it('update agent record', () => {
      ...
      expect(state.records).toEqual([
        { id: 1, name: 'Agent2', email: 'agent2@neuchat.neutron.sg' },
      ]);
    });
  });
