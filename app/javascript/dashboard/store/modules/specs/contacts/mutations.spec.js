...
describe('#mutations', () => {
  describe('#SET_CONTACTS', () => {
    it('set contact records', () => {
      ...
      mutations[types.SET_CONTACTS](state, [
        { id: 2, name: 'contact2', email: 'contact2@neuchat.neutron.sg' },
        { id: 1, name: 'contact1', email: 'contact1@neuchat.neutron.sg' },
      ]);
      expect(state.records).toEqual({
        1: {
          id: 1,
          name: 'contact1',
          email: 'contact1@neuchat.neutron.sg',
        },
        2: {
          id: 2,
          name: 'contact2',
          email: 'contact2@neuchat.neutron.sg',
        },
      });
  ...
  describe('#SET_CONTACT_ITEM', () => {
    it('push contact data to the store', () => {
      const state = {
        records: {
          1: { id: 1, name: 'contact1', email: 'contact1@neuchat.neutron.sg' },
        },
        sortOrder: [1],
      };
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact1', email: 'contact1@neuchat.neutron.sg' },
        2: { id: 2, name: 'contact2', email: 'contact2@neuchat.neutron.sg' },
      });
  ...
  describe('#EDIT_CONTACT', () => {
    it('update contact', () => {
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact2', email: 'contact2@neuchat.neutron.sg' },
      });
    });
  });
