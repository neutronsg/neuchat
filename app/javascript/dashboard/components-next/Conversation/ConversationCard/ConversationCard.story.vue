...
const conversationWithoutMeta = {
  meta: {
    sender: {
      ...
      email: 'candice@neuchat.neutron.sg',
      id: 29,
    ...
    assignee: {
      ...
      autoOffline: false,
      confirmed: true,
      email: 'sivin@neuchat.neutron.sg',
      availableName: 'Sivin',
      name: 'Sivin',
      role: 'administrator',
      thumbnail: '',
  ...
  messages: [
    {
      ...
      conversation: {
        ...
        contactInbox: {
          sourceId: 'candice@neuchat.neutron.sg',
        },
      },
    },
  ],
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@neuchat.neutron.sg',
      },
    },
    sender: {
      id: 1,
...
const conversationWithMeta = {
  meta: {
    sender: {
      additionalAttributes: {},
      availabilityStatus: 'offline',
      email: 'willy@neuchat.neutron.sg',
      id: 29,
      name: 'Willy Castelot',
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      last_activity_at: 1730885428,
      contact_inbox: {
        source_id: 'willy@neuchat.neutron.sg',
      },
    },
    sender: {
      id: 1,
