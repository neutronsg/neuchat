...
const getStatusLabel = displayStatus => {
  const normalizedStatus = String(displayStatus || 'unknown').toLowerCase();

  switch (normalizedStatus) {
    case 'available':
      return t('KNOWLEDGE_BASE.STATUS_AVAILABLE');
    case 'processing':
      return t('KNOWLEDGE_BASE.STATUS_PROCESSING');
    case 'error':
      return t('KNOWLEDGE_BASE.STATUS_ERROR');
    case 'disabled':
      return t('KNOWLEDGE_BASE.STATUS_DISABLED');
    case 'archived':
      return t('KNOWLEDGE_BASE.STATUS_ARCHIVED');
    default:
      return t('KNOWLEDGE_BASE.STATUS_UNKNOWN');
  }
};
