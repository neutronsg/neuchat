...
<template>
  <div class="relative">
    <NextButton
      ...
      :label="$t('INTEGRATION_SETTINGS.NEUAI.AI_ASSIST')"
    ...
    <div
      class="absolute top-0 right-0 -mt-1 -mr-1 w-3 h-3 rounded-full radar-ping-animation bg-n-brand"
    />
    <div
      class="absolute top-0 right-0 -mt-1 -mr-1 w-3 h-3 rounded-full opacity-50 bg-n-brand"
    />
  </div>
</template>
